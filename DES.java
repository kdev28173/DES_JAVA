...
public class DES {
    ...
    public static String encrypt(String pt, String[] rkb, String[] rk) {
        ...
        pt = permute(pt, new int[]{58, 50, 42, 34, 26, 18, 10, 2,
        ...
        for (int i = 0; i < 16; i++) {
            ...
            String right_expanded = permute(right, new int[]{32, 1, 2, 3, 4, 5, 4, 5,
                    6, 7, 8, 9, 8, 9, 10, 11,
            ...
            for (int j = 0; j < 8; j++) {
                int row = bin2dec(Integer.parseInt(xor_x.charAt(j * 6) + "") + Integer.parseInt(xor_x.charAt(j * 6 + 5) + ""));
                int col = bin2dec(Integer.parseInt(xor_x.charAt(j * 6 + 1) + "") + Integer.parseInt(xor_x.charAt(j * 6 + 2) + "") + Integer.parseInt(xor_x.charAt(j * 6 + 3) + "") + Integer.parseInt(xor_x.charAt(j * 6 + 4) + ""));
                int val = sbox[j][row][col];
                sbox_str.append(dec2bin(val));
            }

            sbox_str = new StringBuilder(permute(sbox_str.toString(), new int[]{16, 7, 20, 21,
                    29, 12, 28, 17,
                    1, 15, 23, 26,
                    5, 18, 31, 10,
                    2, 8, 24, 14,
        ...
        String cipher_text = permute(combine, new int[]{40, 8, 48, 16, 56, 24, 64, 32,
    ...
    public static void main(String[] args) {
        String pt = "AAAAAAAAAAAAAAAA"; // Plain text 64bit- 16(hexadecimal values) 
